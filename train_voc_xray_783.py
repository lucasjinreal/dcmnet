...
from datasets.voc_xray783 import VOC_CLASSES, detection_collate
from datasets.voc_xray783 import VOCXray783Detection as VOCDetection
...
def train():
    ...
    '''torch.save(net.state_dict(), args.save_folder +
               '738Final_' + args.version +'_' + args.dataset+ '.pth')'''
    '''torch.save(net.state_dict(), args.save_folder +
               '2392Final_' + args.version +'_' + args.dataset+ '.pth')'''
    torch.save(net.state_dict(), args.save_folder +
               '8718Final_' + args.version + '_' + args.dataset + '.pth')
